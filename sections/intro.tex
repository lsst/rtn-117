...
\begin{enumerate}
    ...
    \item \textbf{Evolving conditions and cadence:} Changing environmental conditions, multi-epoch calibration datasets, and evolving observing strategies require calibration production to be robust to non-uniform survey and telescope operations operations.
...
\S\ref{sec:processing} presents the physical detector model and the calibration and ISR pipeline, including algorithms and data products used in production.
