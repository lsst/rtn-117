...
\begin{enumerate}
    ...
    This is further complicated by partial degeneracies among effects, which necessitate iterative or ``bootstrapped'' approaches to converge on self-consistent calibration products.
    \item \textbf{Evolving conditions and cadence:} Changing environmental conditions, multi-epoch calibration datasets, and evolving observing strategies require calibration production to be robust to non-uniform survey operations.
