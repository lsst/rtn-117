...
Here we discuss the calibration system hardware and performance available for generating the calibration datasets needed as input to the ISR pipeline.
...
In-lab tests with the CCOB are described in \textcolor{red}{here add citation}, the so-called ``Run 7'' was the final campaign of testing of LSSTCam at SLAC National Accelerator Laboratory,
