...
The crosstalk coefficients used during commissioning were generated in the lab at SLAC prior to the camera being shipped to the summit and were quadratic with the source flux, as discussed in \citet{snyder_et_al_2021} (CZW: do we need to introduce the measurement process first?).
