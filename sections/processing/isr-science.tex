...
\begin{figure*}[t]
    ...
    Blue boxes denote signal corrections; orange boxes denote masking or flagging steps; green boxes denote calibration-frame corrections (bias, dark, and flat); white boxes mark the raw input and post-ISR output.}
