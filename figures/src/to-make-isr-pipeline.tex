...
\tikzset{
  ...
  statistic/.style={dash pattern=on 3pt off 2pt},
  % Compact interstitial statistic box (fits in the existing inter-row gap).
  statbox/.style={
    text width=2.6cm,
    minimum height=0pt,
    inner xsep=2.5pt,
...
\stepnode[dynamic, statistic, below=2.2em of raw]{n01}{1}{Convert\\integer\\to float};
\stepnode[dynamic, statistic, right=0.7em of n01]{n02}{2}{Dither counts\\Uniform\\$[-0.5,\,0.5)$};
...
% Inter-row statistic box: branched from serial overscan; does not change row spacing.
\coordinate (gapmid) at ($(n03.south)!0.5!(n08.north)$);
\coordinate (n03n04mid) at ($(n03)!0.75!(n04)$);
\node[
  dynamic,
  statistic,
  statbox,
  ...
  anchor=center,
] (osstats) at (gapmid -| n03n04mid) {%
  \shortstack[c]{Overscan statistics}%
};
...
\stepnode[static, statistic, left=0.7em of n16]{n17}{17}{Variance\\plane\\estimation};
...
\stepnode[static, left=0.7em of n19]{n20}{20}{Amplifier\\offsets};
...
\begin{scope}[on background layer]
  \node[
    ...
    rounded corners=5pt,
    inner sep=10pt,
    fit=(n01)(n02)(n03)(n04)(n05)(n06)(n07)(n08)(n09)(n10)(n11)(n12)(n13)(n14)(n15)(n16)(n17)(n18)(n19)(n20)(osstats),
  ] (isrframe) {};
\end{scope}
\node[
  anchor=south east,
...
\draw[arr, rounded corners=3pt] (n03.south) |- (osstats.west);
...
\begin{scope}[
  ...
  \node[lbl, anchor=north east] (l1) at (legbr) {Static (uses pre-computed calibration inputs)};
  \node[swatch, fill=staticfill, draw=staticline, anchor=east, left=2pt of l1.west] (s1) {};
  \coordinate (l2pos) at ($(l1.south east)+(0,-0.35em)$);
  \node[lbl, anchor=north east] (l2) at (l1.east |- l2pos) {Dynamic};
  ...
  \node[lbl, anchor=north east] (l3) at (l1.east |- l3pos) {Computation};
  \node[swatch, fill=none, draw=black, dash pattern=on 3pt off 2pt, anchor=east, left=2pt of l3.west] (s3) {};
\end{scope}
