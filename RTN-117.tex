...
\newcommand{\docRef}{RTN-117}
\newcommand{\docUpstreamLocation}{\url{https://github.com/lsst/rtn-117}}
...
\input{authors}
\date{\today}
\doi{10.71929/rubin/3488007}
\title{Image Calibration and Instrument Signal Removal for the First Year of the LSST}

% This can write metadata into the PDF.
% Update keywords and author information as necessary.
\hypersetup{
    pdftitle={Image Calibration and Instrument Signal Removal for the First Year of the LSST},
    pdfauthor={broughtona},
    pdfkeywords={}
}
...
\vspace{5mm}
\facilities{Rubin:Simonyi, Rubin:1.2m}
