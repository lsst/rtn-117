...
\input{authors}
\date{\today}
\title{Image Calibration and Instrument Signal Removal for the First Year of Rubin LSSTCam}

% This can write metadata into the PDF.
% Update keywords and author information as necessary.
\hypersetup{
    pdftitle={Image Calibration and Instrument Signal Removal for the First Year of Rubin LSSTCam},
    pdfauthor={watersc},
    pdfkeywords={}
}
